...
const CompanyModel = sequelize.define(
  "Company",
  {
    ...
    maintenance_policy: { type: DataTypes.JSON, allowNull: true, defaultValue: default_maintenance_policy },
    warranty_policy: { type: DataTypes.JSON, allowNull: true, defaultValue: default_warranty_policy },
  },
  {
    tableName: "company",
    timestamps: false,
